...
_0x3:
; 0000 00A2       {
; 0000 00A3              input = getchar();
	CALL _getchar
	MOV  R4,R30
; 0000 00A4              if((input>=48 && input<=57))
	LDI  R30,LOW(48)
	CP   R4,R30
	BRLO _0x7
	LDI  R30,LOW(57)
...
_0x8:
; 0000 00A5              {
; 0000 00A6                 lcd_putchar(input);
	CALL SUBOPT_0x0
; 0000 00A7                 putchar(input);
; 0000 00A8              }
; 0000 00A9              else if(input=='n' || input=='N')
	RJMP _0x9
_0x6:
	LDI  R30,LOW(110)
	CP   R30,R4
...
; 0000 00AE              lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00AF              lcd_puts("Zahra Hosseini");
	__POINTW2MN _0xD,0
	RCALL _lcd_puts
; 0000 00B0              lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 00B1              lcd_puts("Zahra Hosseini");
	__POINTW2MN _0xD,15
	RCALL _lcd_puts
; 0000 00B2 
; 0000 00B3              }
; 0000 00B4              else if(input=='m' || input=='M')
	RJMP _0xE
_0xA:
	LDI  R30,LOW(109)
	CP   R30,R4
...
_0x10:
; 0000 00B5              {
; 0000 00B6               lcd_putchar(input);
	CALL SUBOPT_0x0
; 0000 00B7                 putchar(input);
; 0000 00B8                 putchar(0x0a);
	CALL SUBOPT_0x1
; 0000 00B9                 putchar(0x0d);
; 0000 00BA                 puts("Zahra Hosseini");
	__POINTW2MN _0xD,30
	CALL _puts
; 0000 00BB                 putchar(0x0a);
	CALL SUBOPT_0x1
; 0000 00BC                 putchar(0x0d);
; 0000 00BD              }
; 0000 00BE               else if(input=='c' || input=='C')
	RJMP _0x12
_0xF:
	LDI  R30,LOW(99)
	CP   R30,R4
