...
_0x3:
	.DB  0x4B,0x6F,0x64,0x65,0x69,0x72,0x69,0x0
	.DB  0x53,0x61,0x72,0x61,0x0,0x53,0x61,0x72
	.DB  0x61,0x20,0x4B,0x6F,0x64,0x65,0x69,0x72
	.DB  0x69,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0026     char sarakodeiri[] = "Sara Kodeiri";
; 0000 0027     char sara[] ="Sara";
; 0000 0028     char kodeiri[] = "Kodeiri";
; 0000 0029 
...
_0x4:
; 0000 00A6     {
; 0000 00A7         input = getchar();
	CALL _getchar
	MOV  R17,R30
; 0000 00A8         if (((int)input >= 65 && (int)input <= 90) || ((int)input >= 97 && (int)input <= 122)){              //Checking ascii codes
	MOV  R26,R17
	CLR  R27
	CPI  R26,LOW(0x41)
	LDI  R30,HIGH(0x41)
...
; 0000 00AD         }
; 0000 00AE 
; 0000 00AF         if(input == '5'){
_0x7:
	CPI  R17,53
	BRNE _0xE
; 0000 00B0             putchar(input);
	CALL SUBOPT_0x1
...
; 0000 00B6             lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 00B7             lcd_puts(kodeiri);
	MOVW R26,R28
	RCALL _lcd_puts
; 0000 00B8         }
; 0000 00B9         else if (input == '6'){
	RJMP _0xF
_0xE:
	CPI  R17,54
	BRNE _0x10
; 0000 00BA 
; 0000 00BB             putchar(input);
	CALL SUBOPT_0x1
; 0000 00BC             putchar(0x0d);
; 0000 00BD             putchar(0x0a);
; 0000 00BE             puts(sarakodeiri);
	MOVW R26,R28
	ADIW R26,13
	CALL _puts
; 0000 00BF             putchar(0x0d);
	CALL SUBOPT_0x0
; 0000 00C0             putchar(0x0a);
; 0000 00C1             //lcd_gotoxy(0,0);
; 0000 00C2             //lcd_puts("6");
; 0000 00C3         }
; 0000 00C4 
; 0000 00C5         else if (input == '7'){
	RJMP _0x11
_0x10:
	CPI  R17,55
	BRNE _0x12
; 0000 00C6             putchar(input);
	CALL SUBOPT_0x1
; 0000 00C7             putchar(0x0d);
; 0000 00C8             putchar(0x0a);
; 0000 00C9             lcd_clear();
	RCALL _lcd_clear
; 0000 00CA         }
; 0000 00CB     }
