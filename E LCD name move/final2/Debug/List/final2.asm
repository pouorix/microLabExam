...
_0x0:
	.DB  0x41,0x6C,0x69,0x72,0x65,0x7A,0x61,0x20
	.DB  0x41,0x7A,0x69,0x7A,0x69,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 002B int i =0;
; 0000 002C int posx = 0;
; 0000 002D int posy = 0;
...
; 0000 0062 ICR1L=0x00;
	OUT  0x26,R30
; 0000 0063 OCR1AH=0x7A;
	LDI  R30,LOW(122)
	OUT  0x2B,R30
; 0000 0064 OCR1AL=0x12;
	LDI  R30,LOW(18)
	OUT  0x2A,R30
...
; 0000 0073 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (1<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(16)
	OUT  0x39,R30
; 0000 0074 
...
_0x3:
; 0000 00A6       {
; 0000 00A7       char* name = "Alireza Azizi";
...
; 0000 00B4       posx += 16;
	__ADDWRN 18,19,16
; 0000 00B5       }
; 0000 00B6       lcd_gotoxy( posx, posy);
_0xD:
	ST   -Y,R18
	MOV  R26,R20
	RCALL _lcd_gotoxy
; 0000 00B7       lcd_putchar(name[i]);
	MOVW R30,R16
	LD   R26,Y
	LDD  R27,Y+1
	ADD  R26,R30
