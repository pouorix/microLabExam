...
; 0000 0032  delay_ms(20);
	RCALL SUBOPT_0x1
; 0000 0033 PORTD = 0b11101111;
	LDI  R30,LOW(239)
	OUT  0x12,R30
; 0000 0034 n=(a%100)/10;
	MOVW R26,R16
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	CALL __MODW21
...
; 0000 005F // Clock value: 31.250 kHz
; 0000 0060 // Mode: CTC top=OCR0
; 0000 0061 // OC0 output: Disconnected
; 0000 0062 // Timer Period: 8 ms
; 0000 0063 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (1<<WGM01) | (1<<CS02) | (0<<CS01) | (0<<CS00);
	LDI  R30,LOW(12)
	OUT  0x33,R30
...
; 0000 0089 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (1<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(2)
	OUT  0x39,R30
; 0000 008A 
