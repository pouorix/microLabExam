...
_0x0:
	.DB  0x69,0x64,0x6E,0x61,0x72,0x61,0x59,0x20
	.DB  0x6D,0x61,0x79,0x61,0x50,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 002E char* name = "idnaraY mayaP";
; 0000 002F int i;
; 0000 0030 int x,y;
...
; 0000 0055 // Clock value: 31.250 kHz
; 0000 0056 // Mode: CTC top=OCR1A
...
; 0000 0060 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 0061 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (1<<CS12) | (0<<CS11) | (0<<CS10);
	LDI  R30,LOW(12)
	OUT  0x2E,R30
...
; 0000 0065 ICR1L=0x00;
	OUT  0x26,R30
; 0000 0066 OCR1AH=0x7A;
	LDI  R30,LOW(122)
	OUT  0x2B,R30
; 0000 0067 OCR1AL=0x12;
	LDI  R30,LOW(18)
	OUT  0x2A,R30
...
; 0000 0076 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (1<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(16)
	OUT  0x39,R30
; 0000 0077 
...
; 0000 009B // RS - PORTD Bit 0
; 0000 009C // RD - PORTD Bit 1
; 0000 009D // EN - PORTD Bit 2
; 0000 009E // D4 - PORTD Bit 4
; 0000 009F // D5 - PORTD Bit 5
; 0000 00A0 // D6 - PORTD Bit 6
; 0000 00A1 // D7 - PORTD Bit 7
...
; 0000 00AB         for (i = 0; i < 13; i++)
	__GETWRN 18,19,0
_0x9:
	__CPWRN 18,19,13
	BRGE _0xA
; 0000 00AC         {
; 0000 00AD             x = 15 - index - i;
	MOV  R30,R5
	LDI  R31,0
	LDI  R26,LOW(15)
	LDI  R27,HIGH(15)
...
; 0000 00B8             }
; 0000 00B9 
; 0000 00BA             lcd_gotoxy(x,y);
_0xF:
_0xE:
	ST   -Y,R20
	LDD  R26,Y+1
	RCALL _lcd_gotoxy
; 0000 00BB             lcd_putchar(name[i]);
	MOVW R30,R18
	ADD  R30,R16
	ADC  R31,R17
	LD   R26,Z
